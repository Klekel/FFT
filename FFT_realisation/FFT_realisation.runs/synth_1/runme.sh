...
HD_PWD='C:/Work_task/FFT/FFT_realisation/FFT_realisation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log butterfly_ff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source butterfly_ff.tcl
